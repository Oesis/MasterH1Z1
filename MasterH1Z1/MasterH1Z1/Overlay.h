...
////#include "bf4_x64.h"// you need to download it from Unknown cheats (credits to IChooseYou)
//
...
//		std::cout << "[Overlay] Direct3DCreate9Ex FAIL" << std::endl;
//		return 0;
//	}
//
...
//		std::cout << "[Overlay] CreateDeviceEx FAIL" << std::endl;
//		return 0;
//	}
//
